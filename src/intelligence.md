...
知识图谱的推出，基本上宣告了知识工程进入了一个新的时代，我们称之为大数据时代的知识工程阶段。我们可以利用算法实现数据驱动的大规模自动化知识获取。众包与群智成为大规模知识获取的一条新路径。高质量的UGC内容，为自动挖掘知识提供了高质量数据源。
...
婴儿出生时大脑神经细胞数量基本与成年人相同，大脑外观也与成人一样。然后开始构建神经细胞网络，这个过程会持续到20岁左右。婴儿大脑只有400克左右，成人为1200-1500克，大概到6岁左右大脑重量达到成人的95%，随后到发育缓慢。需要注意的是大脑变重并非是神经细胞增多，而是因为整个神经网络复杂化带来的重量的提升。

成人大脑大约有1000亿个神经元，通过100万亿个突触连接，构成一个超级复杂的神经网络。婴儿在幼儿时期神经元数量已经与成人的差不多，但是神经元之间还没有连接，或者连接非常弱。随着小孩的成长，不断将神经元连接起来，形成神经网络，产生了智能。
